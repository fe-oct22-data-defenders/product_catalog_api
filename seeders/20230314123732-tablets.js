...
const directoryPath = path.join(path.dirname(__dirname), 'api/tablets');
const tablets = [];
...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert(Tablets.tableName, tablets, {});
  },

  async down(queryInterface) {
    await queryInterface.bulkDelete(Tablets.tableName, null, {});
  },
};
