...
const directoryPath = path.join(path.dirname(__dirname), 'api/accessories');
...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert(Accessories.tableName, accessoriesArray, {});
  },

  async down(queryInterface) {
    await queryInterface.bulkDelete(Accessories.tableName, null, {});
  },
};
